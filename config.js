...
${emojis ? '🔔' : '•'} *חדש!* לקבל התראות על מודעות לפי מילות מפתח
...
${emojis ? '🔹' : '•'} *התראות:* הגדירו מילות מפתח וקבלו התראות על מודעות חדשות רלוונטיות

${emojis ? '💡' : ''} *טיפים:*
• השתמשו במילים ברורות בכותרת
• הוסיפו תגיות רלוונטיות לחיפוש טוב יותר
• כתבו תיאור מפורט של השירות
• הגדירו מילות מפתח בהתראות כדי לא לפספס מודעות רלוונטיות
