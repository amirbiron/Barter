...
class KeyboardManager {
    ...
    getPostActionsKeyboardWithSaveStatus(postId, isSaved = false, isAdmin = false) {
        const e = this.emojis;
        const saveButtonText = isSaved ? `${e ? '💔 ' : ''}הסר ממועדפים` : `${e ? '⭐ ' : ''}שמור`;
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        {
                            text: `${e ? '✅ ' : ''}כן, מחק`,
                            callback_data: `confirm_delete_${postId}`,
                        },
                        {
                            text: `${e ? '❌ ' : ''}ביטול`,
                            callback_data: `cancel_delete_${postId}`,
                        },
                    ],
                ],
            },
    ...
    getContactActionsKeyboard(postId, contactInfo) {
        ...
        buttons.push([
            { text: `${e ? '📋 ' : ''}העתק פרטי קשר`, callback_data: `copy_contact_${postId}` },
        ]);
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        ...
                        {
                            text: `${e ? '📞 ' : ''}פניות`,
                            callback_data: `stats_contacts_${postId}`,
                        },
                    ],
                    [
                        ...
                        {
                            text: `${e ? '📤 ' : ''}שיתופים`,
                            callback_data: `stats_shares_${postId}`,
                        },
                    ],
        ...
        return {
            reply_markup: {
                inline_keyboard: [
                    [
                        {
                            text: `${e ? '➕ ' : ''}הוסף מילת מפתח`,
                            callback_data: 'alert_add_keyword',
                        },
                    ],
                    [
                        {
                            text: `${e ? '📋 ' : ''}הצג מילות מפתח`,
                            callback_data: 'alert_show_keywords',
                        },
                    ],
                    [
                        {
                            text: `${e ? '🗑️ ' : ''}מחק מילת מפתח`,
                            callback_data: 'alert_remove_keyword',
                        },
                    ],
                    [
                        {
                            text: `${e ? '🔄 ' : ''}החלף את כל המילות`,
                            callback_data: 'alert_replace_all',
                        },
                    ],
                    [{ text: `${e ? '🔙 ' : ''}תפריט ראשי`, callback_data: 'back_to_main' }],
                ],
